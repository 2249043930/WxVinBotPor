...
实时展示业务数据，包括车辆总数、新增趋势、群聊数量、识别成功率等关键指标。

![数据看板-1](img/image(1).png)

![数据看板-2](img/image(2).png)

### 系统管理

#### API配置管理

支持多模型API配置（OpenAI、豆包、通义千问等），可灵活切换VIN识别引擎。

![API配置](img/image(3).png)

![API配置编辑](img/image(4).png)

#### 用户管理

多用户权限管理，支持添加、编辑、禁用用户账号。

![用户管理](img/image(5).png)

#### 操作日志

完整的操作审计日志，记录用户登录、操作行为。

![操作日志](img/image(6).png)

#### 微信账号管理

管理绑定的微信机器人账号，查看在线状态。

![微信管理](img/image(7).png)

### 群聊管理

#### 群聊配置

统一管理所有监听群聊，支持批量同步微信群信息。

![群聊列表](img/image(8).png)

#### 群聊详细配置

为每个群聊配置专属客服和车型供应商绑定。

![群聊配置](img/image(9).png)

#### 通知配置

灵活配置询价、报价、发货、成交等通知开关，支持工作时间设置和关键词配置。

![通知配置](img/image(12).png)

### 数据统计

#### 车架号识别记录

查看所有VIN识别记录，包括识别状态、车型信息、询价人、报价人等。

![VIN识别记录](img/image(13).png)

#### 消息记录

完整的群聊消息记录，支持按消息类型、日期、群聊筛选。

![消息记录](img/image(14).png)
